...
type Order struct {
	...
	ProductID         uuid.UUID      `gorm:"type:char(36);index:idx_order_product_created,priority:1" json:"product_id"`
	ProductVariantID  *uuid.UUID     `gorm:"type:char(36);index:idx_order_variant" json:"product_variant_id,omitempty"`
