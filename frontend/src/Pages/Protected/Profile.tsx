            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-gray-800 rounded-lg p-6">
                        <h3 className="text-xl font-semibold text-yellow-400 mb-6">Personal Information</h3>
                        <div className="space-y-4">
                            ...
                            <div>
                                <dt className="text-sm font-medium text-gray-400 mb-1">Email Address</dt>
                    ...
                    {/* Quick Actions */}
                    <div className="bg-gray-800 rounded-lg p-6">
                        <h3 className="text-xl font-semibold text-yellow-400 mb-6">Quick Actions</h3>
                        <div className="space-y-4">
                            <Link
                                to="/orders"
                    ...
                    {/* Account Details */}
                    <div className="bg-gray-800 rounded-lg p-6">
                        <h3 className="text-xl font-semibold text-yellow-400 mb-6">Account Details</h3>
                        <div className="space-y-4">
