                ...
                {loading ? (
                    ...
                    <div className="bg-red-900/20 border border-red-800 rounded-lg p-6">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h3 className="text-lg font-medium text-red-300">Error Loading Orders</h3>
                    ...
                    <>
                        <div className="space-y-6">
                            {orders.map((order) => {
                                const productImages = order.product?.images ? parseImages(order.product.images) : [];
                                const firstImage = productImages.length > 0 ? productImages[0] : null;
                                
                                return (
                                    <div key={order.id} className="bg-gray-800 rounded-lg overflow-hidden hover:bg-gray-750 transition-colors duration-200">
